...
int main()
{
  ...
  ifstream fin_ilink1;
  bool validin1 = openDataFile(fin_ilink1, "VMR/MemPrints/InputStubs/InputStubs_IL_L1PHIE_PS10G_1_B_04.dat");
  if (not validin1) return -1;

  ifstream fin_ilink2;
  bool validin2 = openDataFile(fin_ilink2, "VMR/MemPrints/InputStubs/InputStubs_IL_L1PHIE_PS10G_2_B_04.dat");
  if (not validin2) return -1;

  ifstream fin_ilink3;
  bool validin3 = openDataFile(fin_ilink3, "VMR/MemPrints/InputStubs/InputStubs_IL_L1PHIE_neg_PS10G_1_B_04.dat");
  if (not validin3) return -1;

  ifstream fin_ilink4;
  bool validin4 = openDataFile(fin_ilink4, "VMR/MemPrints/InputStubs/InputStubs_IL_L1PHIE_neg_PS10G_2_B_04.dat");
  ...
  // open output files
  ifstream fout_aproj;
  bool valid_aproj = openDataFile(fout_aproj, "VMR/MemPrints/Stubs/AllStubs_AS_L1PHIEn1_04.dat");
  if (not valid_aproj) return -1;

  ifstream fout_vmstubme1;
  bool valid_vmstubme1 =  openDataFile(fout_vmstubme1, "VMR/MemPrints/VMStubsME/VMStubs_VMSME_L1PHIE17n1_04.dat");
  if (not valid_vmstubme1) return -1;

  ifstream fout_vmstubme2;
  bool valid_vmstubme2 = openDataFile(fout_vmstubme2, "VMR/MemPrints/VMStubsME/VMStubs_VMSME_L1PHIE18n1_04.dat");
  if (not valid_vmstubme2) return -1;

  ifstream fout_vmstubme3;
  bool valid_vmstubme3 = openDataFile(fout_vmstubme3, "VMR/MemPrints/VMStubsME/VMStubs_VMSME_L1PHIE19n1_04.dat");
  if (not valid_vmstubme3) return -1;

  ifstream fout_vmstubme4;
  bool valid_vmstubme4 = openDataFile(fout_vmstubme4, "VMR/MemPrints/VMStubsME/VMStubs_VMSME_L1PHIE20n1_04.dat");
...
// TE Inner Overlap
	...
	bool valid_vmstubteol1 = openDataFile(fout_vmstubteol1,
			"VMR/MemPrints/VMStubsTE/VMStubs_VMSTE_L1PHIQ9n1_04.dat");
	if (not valid_vmstubteol1)
		return -1;

	ifstream fout_vmstubteol2;
	bool valid_vmstubteol2 = openDataFile(fout_vmstubteol2,
			"VMR/MemPrints/VMStubsTE/VMStubs_VMSTE_L1PHIQ10n1_04.dat");
