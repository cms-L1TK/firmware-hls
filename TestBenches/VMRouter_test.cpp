...
// AllStub
	...
	bool valid_aproj = openDataFile(fout_aproj,
			"VMR/Stubs/AllStubs_AS_L1PHIEn1_04.dat");
	if (not valid_aproj)
		return -1;
...
// Unit Under Test
		VMRouterTop(bx, &ilink1, &ilink2, &ilink3, 0, 0, 0,
//&ilink7, &ilink8,
