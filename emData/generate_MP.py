...
with open(os.path.join(dirname, arguments.outputDirectory, "MatchProcessor_parameters.h"), "w") as parametersFile, \
    ...
    for mpName in sorted(TPMems.keys()):
        ...
        topHeaderFile.write(
            ...
            "    const VMStubMEMemoryCM<" + VMStubMERegion(seed) + ", " + nrz + ", " + nphi + ", kNMatchEngines>& instubdata,\n"
        ...
        topFile.write(
            ...
            "" + TProjRegion + ", " + VMStubRegion + ", " + nrz + ", " + nphi + ", " + VMProjRegion + ", "  + ASRegion(seed) + ", " + APRegion(seed) + ", " + FMRegion(seed) + ", " + seed + "PHI" + iMP + "maxTrackletProjections" + ", " + seed + "PHI" + iMP + "maxFullMatchCopies" + ",\n"
            " TF::" + seed + ", "
            "TF::" + "D1" + ", "
            "TF::" + iMP + "> (\n"
            "    bx,\n"
