...
parametersFile = open(os.path.join(dirname, "../TrackletAlgorithm/TrackletProcessor_parameters.h"), "w")
...
topHeaderFile = open(os.path.join(dirname, "../TrackletAlgorithm/TrackletProcessorTop.h"), "w")
topHeaderFile.write(
...
topFile = open(os.path.join(dirname, "../TrackletAlgorithm/TrackletProcessorTop.cc"), "w")
topFile.write(
