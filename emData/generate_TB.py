...
with open(os.path.join(dirname, arguments.outputDirectory, "TrackBuilderTop.h"), "w") as topHeaderFile, \
    ...
    parameterFile.write(
        ...
        "template<TF::seed Seed> constexpr int getMPARNPages(const unsigned short);\n"
        "template<TF::seed Seed> constexpr int getMPARMem(const unsigned short);\n"
        "template<TF::seed Seed> constexpr int getMPARPage(const unsigned short);\n"
    )
    ...
    for tbName in sorted(tparMems.keys()):
        ...
        getMPARNPages += "getMPARNPages<TF::" + seed + ">(const unsigned short iTC) {\n"
        ...
        nParentheses = 0
        getMPARMem = "template<> constexpr int\n"
        getMPARMem += "getMPARMem<TF::" + seed + ">(const unsigned short iTC) {\n"
        getMPARMem += "  return "
        ...
        getMPARPage += "getMPARPage<TF::" + seed + ">(const unsigned short iTC) {\n"
        getMPARPage += "  return "
