...
def writeModuleToImplementation(topFile, funcName, prefix, layerDisk, label):
    topFile.write(
        ...
        "\t#pragma HLS interface mode=ap_memory port=inputStubData->get_mem() latency=2\n"
        "\t#pragma HLS interface mode=ap_memory port=inputProjectionData->get_mem() latency=2\n"
        "#endif\n"
        "\n"
