...
# SectorProcessor.vhd
./generator_hdl.py -w reduced_wires.dat -p reduced_processingmodules.dat -m reduced_memorymodules.dat --mut TE -u 0 -d 999
# SectorProcessorFull.vhd
./generator_hdl.py -w reduced_wires.dat -p reduced_processingmodules.dat -m reduced_memorymodules.dat --mut TE -u 0 -d 999 -x
```
