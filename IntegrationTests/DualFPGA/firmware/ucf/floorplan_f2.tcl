...
delete_pblocks -quiet pblock_payload_FTL1L2 pblock_payload_FTL2L3 pblock_payload_FTL3L4 pblock_payload_FTL5L6 pblock_payload_FTD1D2 pblock_payload_FTD3D4 pblock_payload_FTL1D1 pblock_payload_FTL2D1 pblock_payload_KF pblock_payload_KFout pblock_payload_FTAAAA pblock_payload_FTBBBB
...
set pblock_payload_FTAAAArect [find_rects [get_sites -of [get_clock_regions -f {ROW_INDEX>=1 && ROW_INDEX<=4}] -f "RPM_X <= 800"]]
add_rects_to_pblock_mod $lpblock_payload_FTAAAA $pblock_payload_FTAAAArect

set pblock_payload_FTBBBBrect [find_rects [get_sites -of [get_clock_regions -f {ROW_INDEX>=5 && ROW_INDEX<=7}] -f "RPM_X <= 800"]]
