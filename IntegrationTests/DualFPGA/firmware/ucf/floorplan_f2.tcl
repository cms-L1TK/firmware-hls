...
#          payload/tf2_wrapper_1/SectorProcessor_1/FM_L2L3_D1PHIA_DELAY0 \
...
#          payload/tf2_wrapper_1/SectorProcessor_1/FM_L2L3_D1PHIB_DELAY0 \
...
#          payload/tf2_wrapper_1/SectorProcessor_1/FM_L2L3_D1PHIC_DELAY0 \
...
#          payload/tf2_wrapper_1/SectorProcessor_1/FM_L2L3_D1PHID_DELAY0 \
...
#          payload/tf2_wrapper_1/SectorProcessor_1/FM_L2L3_D2PHIA_DELAY0 \
#          payload/tf2_wrapper_1/SectorProcessor_1/FM_L3L4_D2PHIA_DELAY0 \
#          payload/tf2_wrapper_1/SectorProcessor_1/FM_D3D4_D2PHIA_DELAY0 \
...
#          payload/tf2_wrapper_1/SectorProcessor_1/FM_L2L3_D2PHIB_DELAY0 \
#          payload/tf2_wrapper_1/SectorProcessor_1/FM_L3L4_D2PHIB_DELAY0 \
#          payload/tf2_wrapper_1/SectorProcessor_1/FM_D3D4_D2PHIB_DELAY0 \
...
#          payload/tf2_wrapper_1/SectorProcessor_1/FM_L2L3_D2PHIC_DELAY0 \
#          payload/tf2_wrapper_1/SectorProcessor_1/FM_L3L4_D2PHIC_DELAY0 \
#          payload/tf2_wrapper_1/SectorProcessor_1/FM_D3D4_D2PHIC_DELAY0 \
...
#          payload/tf2_wrapper_1/SectorProcessor_1/FM_L2L3_D2PHID_DELAY0 \
#          payload/tf2_wrapper_1/SectorProcessor_1/FM_L3L4_D2PHID_DELAY0 \
#          payload/tf2_wrapper_1/SectorProcessor_1/FM_D3D4_D2PHID_DELAY0 \
...
#          payload/tf2_wrapper_1/SectorProcessor_1/FM_L2L3_D3PHIA_DELAY0 \
#          payload/tf2_wrapper_1/SectorProcessor_1/FM_D1D2_D3PHIA_DELAY0 \
...
#          payload/tf2_wrapper_1/SectorProcessor_1/FM_L2L3_D3PHIB_DELAY0 \
#          payload/tf2_wrapper_1/SectorProcessor_1/FM_D1D2_D3PHIB_DELAY0 \
...
#          payload/tf2_wrapper_1/SectorProcessor_1/FM_L2L3_D3PHIC_DELAY0 \
#          payload/tf2_wrapper_1/SectorProcessor_1/FM_D1D2_D3PHIC_DELAY0 \
...
#          payload/tf2_wrapper_1/SectorProcessor_1/FM_L2L3_D3PHID_DELAY0 \
#          payload/tf2_wrapper_1/SectorProcessor_1/FM_D1D2_D3PHID_DELAY0 \
...
#          payload/tf2_wrapper_1/SectorProcessor_1/FM_L2L3_D4PHIA_DELAY0 \
#          payload/tf2_wrapper_1/SectorProcessor_1/FM_D1D2_D4PHIA_DELAY0 \
...
#          payload/tf2_wrapper_1/SectorProcessor_1/FM_L2L3_D4PHIB_DELAY0 \
#          payload/tf2_wrapper_1/SectorProcessor_1/FM_D1D2_D4PHIB_DELAY0 \
...
#          payload/tf2_wrapper_1/SectorProcessor_1/FM_L2L3_D4PHIC_DELAY0 \
#          payload/tf2_wrapper_1/SectorProcessor_1/FM_D1D2_D4PHIC_DELAY0 \
...
#          payload/tf2_wrapper_1/SectorProcessor_1/FM_L2L3_D4PHID_DELAY0 \
#          payload/tf2_wrapper_1/SectorProcessor_1/FM_D1D2_D4PHID_DELAY0 \
...
set pblock_payload_FTL1L2rect [find_rects [get_sites -of [get_clock_regions -f {ROW_INDEX>=4 && ROW_INDEX<=4}] -f "RPM_X <= $MP_XBOUNDARY1"]]
add_rects_to_pblock_mod $lpblock_payload_FTL1L2 $pblock_payload_FTL1L2rect

set pblock_payload_FTD1D2rect [find_rects [get_sites -of [get_clock_regions -f {ROW_INDEX>=5 && ROW_INDEX<=5}] -f "RPM_X <= $MP_XBOUNDARY1"]]
add_rects_to_pblock_mod $lpblock_payload_FTD1D2 $pblock_payload_FTD1D2rect

set pblock_payload_FTD3D4rect [find_rects [get_sites -of [get_clock_regions -f {ROW_INDEX>=6 && ROW_INDEX<=6}] -f "RPM_X <= $MP_XBOUNDARY1"]]
add_rects_to_pblock_mod $lpblock_payload_FTD3D4 $pblock_payload_FTD3D4rect

set pblock_payload_FTL1D1rect [find_rects [get_sites -of [get_clock_regions -f {ROW_INDEX>=7 && ROW_INDEX<=7}] -f "RPM_X <= $MP_XBOUNDARY1"]]
add_rects_to_pblock_mod $lpblock_payload_FTL1D1 $pblock_payload_FTL1D1rect

set pblock_payload_FTL2D1rect [find_rects [get_sites -of [get_clock_regions -f {ROW_INDEX>=7 && ROW_INDEX<=7}] -f "RPM_X <= $MP_XBOUNDARY1"]]
add_rects_to_pblock_mod $lpblock_payload_FTL2D1 $pblock_payload_FTL2D1rect

set pblock_payload_FTL2L3rect [find_rects [get_sites -of [get_clock_regions -f {ROW_INDEX>=3 && ROW_INDEX<=3}] -f "RPM_X <= $MP_XBOUNDARY1"]]
add_rects_to_pblock_mod $lpblock_payload_FTL2L3 $pblock_payload_FTL2L3rect

set pblock_payload_FTL3L4rect [find_rects [get_sites -of [get_clock_regions -f {ROW_INDEX>=2 && ROW_INDEX<=2}] -f "RPM_X <= $MP_XBOUNDARY1"]]
add_rects_to_pblock_mod $lpblock_payload_FTL3L4 $pblock_payload_FTL3L4rect

set pblock_payload_FTL5L6rect [find_rects [get_sites -of [get_clock_regions -f {ROW_INDEX>=1 && ROW_INDEX<=1}] -f "RPM_X <= $MP_XBOUNDARY1"]]
