...
create_ip -name VMSMERouter_L1A -module_name VMSMER_L1A -vendor xilinx.com -library hls -version 1.0
create_ip -name VMSMERouter_L1B -module_name VMSMER_L1B -vendor xilinx.com -library hls -version 1.0
create_ip -name VMSMERouter_L1C -module_name VMSMER_L1C -vendor xilinx.com -library hls -version 1.0
create_ip -name VMSMERouter_L1D -module_name VMSMER_L1D -vendor xilinx.com -library hls -version 1.0
create_ip -name VMSMERouter_L1E -module_name VMSMER_L1E -vendor xilinx.com -library hls -version 1.0
create_ip -name VMSMERouter_L1F -module_name VMSMER_L1F -vendor xilinx.com -library hls -version 1.0
create_ip -name VMSMERouter_L1G -module_name VMSMER_L1G -vendor xilinx.com -library hls -version 1.0
create_ip -name VMSMERouter_L1H -module_name VMSMER_L1H -vendor xilinx.com -library hls -version 1.0
create_ip -name VMSMERouter_L2A -module_name VMSMER_L2A -vendor xilinx.com -library hls -version 1.0
create_ip -name VMSMERouter_L2B -module_name VMSMER_L2B -vendor xilinx.com -library hls -version 1.0
create_ip -name VMSMERouter_L2C -module_name VMSMER_L2C -vendor xilinx.com -library hls -version 1.0
create_ip -name VMSMERouter_L2D -module_name VMSMER_L2D -vendor xilinx.com -library hls -version 1.0
create_ip -name VMSMERouter_L3A -module_name VMSMER_L3A -vendor xilinx.com -library hls -version 1.0
create_ip -name VMSMERouter_L3B -module_name VMSMER_L3B -vendor xilinx.com -library hls -version 1.0
create_ip -name VMSMERouter_L3C -module_name VMSMER_L3C -vendor xilinx.com -library hls -version 1.0
create_ip -name VMSMERouter_L3D -module_name VMSMER_L3D -vendor xilinx.com -library hls -version 1.0
create_ip -name VMSMERouter_L4A -module_name VMSMER_L4A -vendor xilinx.com -library hls -version 1.0
create_ip -name VMSMERouter_L4B -module_name VMSMER_L4B -vendor xilinx.com -library hls -version 1.0
create_ip -name VMSMERouter_L4C -module_name VMSMER_L4C -vendor xilinx.com -library hls -version 1.0
create_ip -name VMSMERouter_L4D -module_name VMSMER_L4D -vendor xilinx.com -library hls -version 1.0
create_ip -name VMSMERouter_L5A -module_name VMSMER_L5A -vendor xilinx.com -library hls -version 1.0
create_ip -name VMSMERouter_L5B -module_name VMSMER_L5B -vendor xilinx.com -library hls -version 1.0
create_ip -name VMSMERouter_L5C -module_name VMSMER_L5C -vendor xilinx.com -library hls -version 1.0
create_ip -name VMSMERouter_L5D -module_name VMSMER_L5D -vendor xilinx.com -library hls -version 1.0
create_ip -name VMSMERouter_L6A -module_name VMSMER_L6A -vendor xilinx.com -library hls -version 1.0
create_ip -name VMSMERouter_L6B -module_name VMSMER_L6B -vendor xilinx.com -library hls -version 1.0
create_ip -name VMSMERouter_L6C -module_name VMSMER_L6C -vendor xilinx.com -library hls -version 1.0
create_ip -name VMSMERouter_L6D -module_name VMSMER_L6D -vendor xilinx.com -library hls -version 1.0
create_ip -name VMSMERouter_D1A -module_name VMSMER_D1A -vendor xilinx.com -library hls -version 1.0
create_ip -name VMSMERouter_D1B -module_name VMSMER_D1B -vendor xilinx.com -library hls -version 1.0
create_ip -name VMSMERouter_D1C -module_name VMSMER_D1C -vendor xilinx.com -library hls -version 1.0
create_ip -name VMSMERouter_D1D -module_name VMSMER_D1D -vendor xilinx.com -library hls -version 1.0
create_ip -name VMSMERouter_D2A -module_name VMSMER_D2A -vendor xilinx.com -library hls -version 1.0
create_ip -name VMSMERouter_D2B -module_name VMSMER_D2B -vendor xilinx.com -library hls -version 1.0
create_ip -name VMSMERouter_D2C -module_name VMSMER_D2C -vendor xilinx.com -library hls -version 1.0
create_ip -name VMSMERouter_D2D -module_name VMSMER_D2D -vendor xilinx.com -library hls -version 1.0
create_ip -name VMSMERouter_D3A -module_name VMSMER_D3A -vendor xilinx.com -library hls -version 1.0
create_ip -name VMSMERouter_D3B -module_name VMSMER_D3B -vendor xilinx.com -library hls -version 1.0
create_ip -name VMSMERouter_D3C -module_name VMSMER_D3C -vendor xilinx.com -library hls -version 1.0
create_ip -name VMSMERouter_D3D -module_name VMSMER_D3D -vendor xilinx.com -library hls -version 1.0
create_ip -name VMSMERouter_D4A -module_name VMSMER_D4A -vendor xilinx.com -library hls -version 1.0
create_ip -name VMSMERouter_D4B -module_name VMSMER_D4B -vendor xilinx.com -library hls -version 1.0
create_ip -name VMSMERouter_D4C -module_name VMSMER_D4C -vendor xilinx.com -library hls -version 1.0
create_ip -name VMSMERouter_D4D -module_name VMSMER_D4D -vendor xilinx.com -library hls -version 1.0
create_ip -name VMSMERouter_D5A -module_name VMSMER_D5A -vendor xilinx.com -library hls -version 1.0
create_ip -name VMSMERouter_D5B -module_name VMSMER_D5B -vendor xilinx.com -library hls -version 1.0
create_ip -name VMSMERouter_D5C -module_name VMSMER_D5C -vendor xilinx.com -library hls -version 1.0
create_ip -name VMSMERouter_D5D -module_name VMSMER_D5D -vendor xilinx.com -library hls -version 1.0
