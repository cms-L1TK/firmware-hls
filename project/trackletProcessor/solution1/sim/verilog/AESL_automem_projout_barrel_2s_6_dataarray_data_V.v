...
module AESL_automem_projout_barrel_2s_6_dataarray_data_V (
    clk,
    rst,
    ce0,
    we0,
...
//------------------------Parameter----------------------
localparam
    TV_IN  = "../tv/cdatafile/c.TrackletProcessor_L2L3C.autotvin_projout_barrel_2s_6_dataarray_data_V.dat", 
    TV_OUT = "../tv/rtldatafile/rtl.TrackletProcessor_L2L3C.autotvout_projout_barrel_2s_6_dataarray_data_V.dat"; 
//------------------------Local signal-------------------
parameter DATA_WIDTH = 32'd 58;
