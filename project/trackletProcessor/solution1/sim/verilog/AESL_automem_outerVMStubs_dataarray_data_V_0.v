...
module AESL_automem_outerVMStubs_dataarray_data_V_0 (
    clk,
    rst,
    ce0,
    we0,
...
//------------------------Parameter----------------------
localparam
    TV_IN  = "../tv/cdatafile/c.TrackletProcessor_L2L3C.autotvin_outerVMStubs_dataarray_data_V_0.dat", 
    TV_OUT = "../tv/rtldatafile/rtl.TrackletProcessor_L2L3C.autotvout_outerVMStubs_dataarray_data_V_0.dat"; 
//------------------------Local signal-------------------
