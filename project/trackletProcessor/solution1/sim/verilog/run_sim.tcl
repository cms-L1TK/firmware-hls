...
if {[file isfile TrackletProcessor_L2L3C.autotvin.dat]} {
	file delete -force TrackletProcessor_L2L3C.autotvin.dat
}

if {[file isfile TrackletProcessor_L2L3C.autotvout.dat]} {
	file delete -force TrackletProcessor_L2L3C.autotvout.dat
}
