...
// Memory written by the MatchProcessor, containing the association between a stub and a tracklet,
// in a layer that the tracklet seed has been projected to and a matching stub found.
