...
#pragma HLS array_partition variable=addrCountASI dim=0
#pragma HLS array_partition variable=addrCountME dim=0
#pragma HLS array_partition variable=addrCountTE dim=0
