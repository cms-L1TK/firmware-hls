#ifndef TrackletAlgorithm_TrackQualityMemory_h
#define TrackletAlgorithm_TrackQualityMemory_h
...
public:
  ...
  enum BitWidths {
    ...
    TrackSize = InvRSize + PhiSize + TanLSize + Z0Size 
              ...
              + HitPatternSize + MVATQSize + MVAresSize + TkValidSize + 2*kNBits_MemAddr
  };
...
// Memory definition
typedef MemoryTemplate<TTTrack, 2, kNBits_MemAddr> TTTrackMemory;
