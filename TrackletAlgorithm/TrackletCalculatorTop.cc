...
void TrackletCalculator_L1L2E(
    const BXType bx,
    const AllStubMemory<BARRELPS> innerStubs[NASMemInner<TF::L1L2, TC::E>()],
    const AllStubMemory<BARRELPS> outerStubs[NASMemOuter<TF::L1L2, TC::E>()],
...
void TrackletCalculator_L1L2G(
    const BXType bx,
    const AllStubMemory<BARRELPS> innerStubs[NASMemInner<TF::L1L2, TC::G>()],
    const AllStubMemory<BARRELPS> outerStubs[NASMemOuter<TF::L1L2, TC::G>()],
...
void TrackletCalculator_L3L4E(
    const BXType bx,
    const AllStubMemory<BARRELPS> innerStubs[NASMemInner<TF::L3L4, TC::E>()],
    const AllStubMemory<BARREL2S> outerStubs[NASMemOuter<TF::L3L4, TC::E>()],
