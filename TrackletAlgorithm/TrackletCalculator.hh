...
////////////////////////////////////////////////////////////////////////////////
  ...
  TC_L1L2(
    ...
    const Types::rmean rproj0_wire,
    const Types::rmean rproj1_wire,
    const Types::rmean rproj2_wire,
    const Types::rmean rproj3_wire,
    const Types::zmean zproj0_wire,
    const Types::zmean zproj1_wire,
    const Types::zmean zproj2_wire,
    const Types::zmean zproj3_wire,

    Types::rinv * const rinv_final_wire,
    ...
    Types::phiL * const phiL_0_final_wire,
    Types::phiL * const phiL_1_final_wire,
    Types::phiL * const phiL_2_final_wire,
    Types::phiL * const phiL_3_final_wire,
    Types::zL * const zL_0_final_wire,
    Types::zL * const zL_1_final_wire,
    Types::zL * const zL_2_final_wire,
    Types::zL * const zL_3_final_wire,
    Types::der_phiL * const der_phiL_final_wire,
    Types::der_zL * const der_zL_final_wire,
    Types::phiD * const phiD_0_final_wire,
    Types::phiD * const phiD_1_final_wire,
    Types::phiD * const phiD_2_final_wire,
    Types::phiD * const phiD_3_final_wire,
    Types::rD * const rD_0_final_wire,
    Types::rD * const rD_1_final_wire,
    Types::rD * const rD_2_final_wire,
    Types::rD * const rD_3_final_wire,
    Types::der_phiD * const der_phiD_final_wire,
    Types::der_rD * const der_rD_final_wire
  );
