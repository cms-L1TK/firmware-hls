...
template <regionType INTYPE>
inline
ap_uint<5> iphivmRawPlus(const typename AllStub<INTYPE>::ASPHI phi)
{
  // // TODO: get rid of hard-coded values
...
template <regionType INTYPE>
inline
ap_uint<5> iphivmRawMinus(const typename AllStub<INTYPE>::ASPHI phi)
{
  ap_uint<7> tmp(phi.range(phi.length()-1,phi.length()-7));
  auto iphivmp = --tmp;
...
template <regionType INTYPE, regionType METYPE, int LAYER, int DISK, int NINPUTS, uint32_t MEMASK>
void VMRouter(
  const BXType bx,
  // Input memories
  ...
  // ME memories
  VMStubMEMemory<INTYPE> *m0,
  VMStubMEMemory<INTYPE> *m1,
  VMStubMEMemory<INTYPE> *m2,
  VMStubMEMemory<INTYPE> *m3,
  VMStubMEMemory<INTYPE> *m4,
  VMStubMEMemory<INTYPE> *m5,
  VMStubMEMemory<INTYPE> *m6,
  VMStubMEMemory<INTYPE> *m7,
  VMStubMEMemory<INTYPE> *m8,
  VMStubMEMemory<INTYPE> *m9,
  VMStubMEMemory<INTYPE> *m10,
  VMStubMEMemory<INTYPE> *m11,
  VMStubMEMemory<INTYPE> *m12,
  VMStubMEMemory<INTYPE> *m13,
  VMStubMEMemory<INTYPE> *m14,
  VMStubMEMemory<INTYPE> *m15,
  VMStubMEMemory<INTYPE> *m16,
  VMStubMEMemory<INTYPE> *m17,
  VMStubMEMemory<INTYPE> *m18,
  VMStubMEMemory<INTYPE> *m19,
  VMStubMEMemory<INTYPE> *m20,
  VMStubMEMemory<INTYPE> *m21,
  VMStubMEMemory<INTYPE> *m22,
  VMStubMEMemory<INTYPE> *m23,
  VMStubMEMemory<INTYPE> *m24,
  VMStubMEMemory<INTYPE> *m25,
  VMStubMEMemory<INTYPE> *m26,
  VMStubMEMemory<INTYPE> *m27,
  VMStubMEMemory<INTYPE> *m28,
  VMStubMEMemory<INTYPE> *m29,
  VMStubMEMemory<INTYPE> *m30,
  VMStubMEMemory<INTYPE> *m31)
{
...
;
  ...
  TOPLEVEL: for(auto i = 0; i < kMaxProc; ++i ) {
    ...
    const bool haveData = (n_i0>0)||(n_i1>0)||(n_i2>0)||(n_i3>0)||(n_i4>0)||(n_i5>0);
