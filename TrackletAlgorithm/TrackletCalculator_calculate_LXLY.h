...
inline void projToLayer(ap_uint<13> ir, ap_uint<13> irtilde, int irinv, int iphi0, int it,int iz0, TC::Types::zL &iz, TC::Types::phiL &iphi) {
...
inline void projToDisk(int iz, int itinv, int irinv, int iphi0, int it,int iz0, TC::Types::rD  &ir, TC::Types::phiD  &iphi) {
