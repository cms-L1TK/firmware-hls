...
cmsenv
git cms-checkout-topic -u cms-L1TK:fw_synch_250430
...
The wires files for the reduced configuration are currently [stored in the cms-L1TK/cmssw repo](https://github.com/cms-L1TK/cmssw/tree/fw_synch_250430/L1Trigger/TrackFindingTracklet/data) (see next section for instructions for generating these).
